...
import { HeroCentered, HeroSplit, HeroGradient, HeroWithFeatures, HeroAnimated, HeroBackgroundAnimated, HeroRetro } from '@/components/patterns/heroes'
    ...
    />
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            A neo-brutalism inspired hero section with high contrast borders and shadows.
          </p>
          <PreviewCodeTabs code={retroCode}>
            <HeroRetro
              eyebrow="New Collection 2024"
              title="Bold. Retro. Unique."
              subtitle="Stand out from the crowd with our new design system components. Built for impact."
              actions={[
